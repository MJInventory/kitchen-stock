...
export async function buildPageRouteDefinitions(helpers) {
  ...
  return [
    ...
    },
    {
      ...
      options: mergeOptions(setupShellBase, {
        pageTitle: "Item Admin",
        pageEyebrow: "Inventory",
        beforeMain: await loginPartial("Item Admin", "Inventory", { numericPassword: true }),
        footerScripts: pageScripts("/inventory-settings.js")
      })
    },
    {
      path: "/internal-data.html",
      view: "pages/internal-data",
      options: mergeOptions(setupShellBase, {
        pageTitle: "Internal Data",
        pageEyebrow: "Security",
        beforeMain: await loginPartial("Internal Data", "Security", { numericPassword: true }),
        footerScripts: pageScripts("/internal-data.js")
      })
    },
    {
    ...
    },
    {
      ...
      view: "pages/ordering",
      options: mergeOptions(orderShellBase, {
        bodyClass: "order-app ordering-modern-app",
        contentClass: "shell setup-shell",
