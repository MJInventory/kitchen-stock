...
import { enforceInventoryPriceDefaults } from "./postgres-migrations/012-enforce-inventory-price-defaults.js";
import { addSecurityAdminAndInternalData } from "./postgres-migrations/013-add-security-admin-and-internal-data.js";
import { addDesktopIdleTimeoutSetting } from "./postgres-migrations/014-add-desktop-idle-timeout-setting.js";
import { addScreenAccessControls } from "./postgres-migrations/015-add-screen-access-controls.js";
import { addSupplierSpecificItemPrices } from "./postgres-migrations/016-add-supplier-specific-item-prices.js";
...
export const POSTGRES_MIGRATIONS = [
  ...
  {
    version: "012_enforce_inventory_price_defaults",
    description: "Backfill inventory prices and enforce 0.00 defaults",
    migrate: enforceInventoryPriceDefaults
  },
  {
    version: "013_add_security_admin_and_internal_data",
    description: "Add Security Admin role and internal data storage table",
    migrate: addSecurityAdminAndInternalData
  },
  {
    version: "014_add_desktop_idle_timeout_setting",
    description: "Add a per-user desktop inactivity timeout setting",
    migrate: addDesktopIdleTimeoutSetting
  },
  {
    version: "015_add_screen_access_controls",
    description: "Add God-managed per-user screen access controls",
    migrate: addScreenAccessControls
  },
  {
    version: "016_add_supplier_specific_item_prices",
    description: "Store item prices by supplier and snapshot order prices",
    migrate: addSupplierSpecificItemPrices
  }
];
