...
import { ensurePostgresSchemaUpgrades as applyPostgresSchemaUpgrades } from "./postgres-schema.js";
...
import { createRuntimeDataHelpers } from "./runtime-data.js";
...
export function createServerComposition({
  ...
  const legacyRuntimeData = createRuntimeDataHelpers({
    token: config.token,
