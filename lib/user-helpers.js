...
export function createUserHelpers({
  ...
  function publicUser(user) {
    ...
    return {
      ...
      settings: {
        ...
        blockedGotoMenu: normalizeHiddenMenuItems(user?.blockedGotoMenu ?? user?.blocked_goto_menu, gotoMenuOptions),
        blockedBackofficeMenu: normalizeHiddenMenuItems(user?.blockedBackofficeMenu ?? user?.blocked_backoffice_menu, backofficeMenuOptions),
  ...
  function mapPgAppUserRow(row) {
    return {
      ...
      blockedGotoMenu: normalizeHiddenMenuItems(row.blocked_goto_menu, gotoMenuOptions),
      blockedBackofficeMenu: normalizeHiddenMenuItems(row.blocked_backoffice_menu, backofficeMenuOptions),
